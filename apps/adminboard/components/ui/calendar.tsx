...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-oklch(1 0 0) group/calendar dark:bg-oklch(0.141 0.005 285.823) p-3 [--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',

 ...
 * Sourced from apps/website/public/temp-blogs — media slots use stand-in assets
 * until final photos/videos are supplied.
 */

import type { Author, Post } from './types'

/** Stand-in until real cover / body media is uploaded. */
const MEDIA_PLACEHOLDER = '/site_front.png'
    ...
    body: [
      {
        kind: 'image',
        src: '/conf_img.png',
        alt: 'Speakers at the Panhellenic Physiotherapy Conference',
        caption:
          'Placeholder — speakers photo (pitch deck asset currently in use).',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        ...
        alt: 'Placeholder for keynote talk video',
        caption: 'Video placeholder — embed YouTube video of the keynote talk.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for round-table discussion video',
        caption:
          'Video placeholder — embed YouTube video of the round-table discussion.',
      },
      {
        kind: 'heading',
        level: 2,
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for team at the booth',
        caption: 'Photo placeholder — team at the exhibition booth.',
      },
      {
        kind: 'paragraph',
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for Piraeus Startup Accelerator photo',
        caption: 'Photo placeholder — high-quality event photo.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for networking or team photo',
        caption:
          'Photo placeholder — networking event or team photo from the accelerator.',
      },
      {
        kind: 'heading',
        level: 2,
        text: 'Strategic Acknowledgments',
      },
      {
        kind: 'paragraph',
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for InnoDays booth Δ07',
        caption:
          'Photo placeholder — booth Δ07, ideally with people wearing the VR headset.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for team at InnoDays booth',
        caption:
          'Photo placeholder — team talking to investors or smiling at the booth.',
      },
      {
        kind: 'paragraph',
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for Xanthi panel speaking photo',
        caption:
          'Photo placeholder — speaking on the panel or at the event venue.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for panel discussion photo',
        caption:
          'Photo placeholder — panel discussion or networking with new applicants.',
      },
      {
        kind: 'heading',
        level: 2,
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for seminar photo',
        caption: 'Photo placeholder — from the ACL rehabilitation seminar.',
      },
      {
        kind: 'paragraph',
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for Delphi Economic Forum stage photo',
        caption:
          'Photo placeholder — on stage with the Delphi Economic Forum backdrop or panel.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for Delphi panel or networking photo',
        caption:
          'Photo placeholder — panel or networking moment from the forum.',
      },
      {
        kind: 'heading',
        level: 2,
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for WE4G program photo',
        caption:
          'Photo placeholder — WE4G branding, design sprint screenshot, or founder headshot.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for design sprint session photo',
        caption:
          'Photo placeholder — online design sprint session or team working remotely.',
      },
      {
        kind: 'heading',
        level: 2,
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for Panathēnea booth photo',
        caption:
          'Photo placeholder — team at the Piraeus Bank booth, ideally with attendees viewing the VR headset.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for visitor trying VR headset',
        caption:
          'Photo placeholder — visitor trying the Virtality VR headset or interacting with the team.',
      },
      {
        kind: 'heading',
        level: 2,
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for BEYOND Expo booth photo',
        caption:
          'Photo placeholder — team at the Startup Village kiosk or Region of Crete pavilion.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for visitors at BEYOND booth',
        caption:
          'Photo placeholder — visitors or clinicians interacting with the Virtality team at one of the booths.',
      },
      {
        kind: 'heading',
        level: 2,
    ...
    body: [
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for VivaTech stage presentation photo',
        caption:
          'Photo placeholder — presenting on the VivaTech stage with WE4G / HEC Paris branding.',
      },
      {
        kind: 'paragraph',
      ...
      },
      {
        kind: 'image',
        src: MEDIA_PLACEHOLDER,
        alt: 'Placeholder for VivaTech floor or networking photo',
        caption:
          'Photo placeholder — technologies on the exhibition floor, or networking at the event.',
      },
      {
        kind: 'heading',
        level: 2,

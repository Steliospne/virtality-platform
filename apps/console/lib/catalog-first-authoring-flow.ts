...
/** Primary action on the catalog step: return to settings (selected-list). */
export const CATALOG_FIRST_CATALOG_CONTINUE_LABEL = 'Continue'

/** Label shown near the catalog Continue action on the catalog step. */

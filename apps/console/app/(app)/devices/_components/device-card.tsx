...
import { subscribeToPairingEvents } from '@/lib/device-event-controller'
...
const DeviceCard = ({ device }: DeviceProps) => {
  ...
  useEffect(() => {
    ...
    return subscribeToPairingEvents(device.socket, {
      onSendDeviceId: handleSendDeviceId,
      onDisconnect,
    })

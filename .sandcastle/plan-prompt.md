...
!`gh issue list --state open --limit 100 --label "ready-for-agent,Sandcastle" --json number,title,body,labels,comments --jq '[.[] | {number, title, body, labels: [.labels[].name], comments: [.comments[].body]}]'`

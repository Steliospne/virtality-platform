  ...
  [
    {
      ...
      checks: [
        ...
        'Continue returns to settings (selected-list); Add exercises returns to catalog',
        'Selected exercise count appears on the catalog step',
        'Finalize and Save Program are disabled when no enabled variants remain',
        'Finalize opens a save reminder dialog before loading the session',
    ...
    },
    {
      ...
      checks: [
        ...
        'Continue returns to settings; program name field is visible on the settings step',
        'Add exercises opens the catalog; Continue/Back returns to settings',
    ...
    },
    {
      ...
      checks: [
        ...
        'Add exercises opens the catalog; Continue/Back returns with selections preserved',
        'Submit is blocked when no enabled variants remain',
      ],
    },
    {
